...
<center><div>
<br><br><br><br>
<p style="font-family: cursive;color: maroon;font-size: 20px;font-weight: bolder;">Charges applied</p><br><font color="red">${msg }</font>
<table>
<%
...
<td><input type="number" align="right" name="mcharge" placeholder="MaintananceCost"  required size="20px" value="<%=rs.getInt(1) %>"/></td>
</tr><tr>
<td>Parking Charge:</td>
<td><input type="number" align="right" name="pcharge" placeholder="Parking charge"  required size="20px"  value="<%=rs.getInt(2) %>"/></td>
</tr><tr>
<td>Water Charge:</td>
<td><input type="number" align="right" name="wcharge" placeholder="Water charge"  required size="20px"  value="<%=rs.getInt(3) %>"/></td>

</tr><tr>
<td>Event Charge:</td>
<td><input type="number" align="right" name="echarge" placeholder="Event charge"  required size="20px"  value="<%=rs.getInt(4) %>"/></td>
</tr>
<tr>
<td></td>
