 ...
 * Generated at: 2016-12-06 06:08:06 UTC
...
public final class pownerentry_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("</head>\n");
      out.write("<body>\n");
      out.write("\t<form action=\"flch\" method=\"post\">\n");
      ...
      out.write("\t\t\t\t\t<br>\n");
      out.write("\t\t\t\t\t<p\n");
      out.write("\t\t\t\t\t\tstyle=\"font-family: cursive; color: maroon; font-size: 20px; font-weight: bolder;\">Owners\n");
      out.write("\t\t\t\t\t\tentry</p>\n");
      out.write("\t\t\t\t\t<table>\n");
      out.write("\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t<td>Enter Flat No:</td>\n");
      out.write("\t\t\t\t\t\t\t<td><input type=\"text\" name=\"flatno\" placeholder=\"FlatNo:\"\n");
      out.write("\t\t\t\t\t\t\t\trequired size=\"50px\" /></td>\n");
      out.write("\t\t\t\t\t\t</tr>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t<tr>\n");
      out.write("\t\t\t\t\t\t\t<td></td>\n");
      out.write("\t\t\t\t\t\t\t<td align=\"right\"><input type=\"submit\" name=\"sowner\"\n");
      out.write("\t\t\t\t\t\t\t\tvalue=\"proceed\" style=\"width: 100px; height: 40px\" /><br><font style=\"color: red;font-weight: bold;\">");
