 ...
 * Generated at: 2016-12-07 05:24:08 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t<br>\n");
      out.write("\t\t\t\t\t<p\n");
      out.write("\t\t\t\t\t\tstyle=\"font-family: cursive; color: maroon; font-size: 20px; font-weight: bolder;\">Total\n");
      out.write("\t\t\t\t\t\tBill</p>\n");
      out.write("\t\t\t\t\t<br>\n");
      ...
      out.write("\t\t\t\t\t\t\t<td><input type=\"number\" align=\"right\" readonly=\"readonly\"\n");
      out.write("\t\t\t\t\t\t\t\tname=\"mcharge\" placeholder=\"MaintananceCost\" required\n");
      out.write("\t\t\t\t\t\t\t\tsize=\"20px\" value=\"");
      ...
      out.write("\t\t\t\t\t\t\t<td><input type=\"number\" align=\"right\" readonly=\"readonly\"\n");
      out.write("\t\t\t\t\t\t\t\tname=\"pcharge\" placeholder=\"Parking charge\" required size=\"20px\"\n");
      out.write("\t\t\t\t\t\t\t\tvalue=\"");
      ...
      out.write("\t\t\t\t\t\t\t<td><input type=\"number\" align=\"right\" readonly=\"readonly\"\n");
      out.write("\t\t\t\t\t\t\t\tname=\"wcharge\" placeholder=\"Water charge\" required size=\"20px\"\n");
      out.write("\t\t\t\t\t\t\t\tvalue=\"");
      ...
      out.write("\t\t\t\t\t\t\t<td><input type=\"number\" align=\"right\" readonly=\"readonly\"\n");
      out.write("\t\t\t\t\t\t\t\tname=\"echarge\" placeholder=\"Event charge\" required size=\"20px\"\n");
      out.write("\t\t\t\t\t\t\t\tvalue=\"");
