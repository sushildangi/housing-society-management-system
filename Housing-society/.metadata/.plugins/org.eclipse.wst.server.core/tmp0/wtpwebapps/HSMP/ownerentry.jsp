...
<body>
	<form action="svinfo" method="post" enctype="multipart/form-data">
		<div id="templatemo_wrapper">
			...
			<center>
				<div>
					...
					<br>
					<p
						style="font-family: cursive; color: maroon; font-size: 35px; font-weight: bolder;">Owners
						Entry</p>
					<table>
						<tr>
							<td>Enter Flat No:</td>
							<td><input type="text" name="flatno" placeholder="FlatNo:"
								size="50px" readonly="readonly"  required value = "${fno}"/></td>
						</tr>
						<tr>
							<td>Enter name:</td>
						...
						<tr>
							...
							<td><input type="submit" name="sowner" value="save"
								style="width: 100px; height: 40px" /> <input type="submit"
								name="aowner" value="Add members"
