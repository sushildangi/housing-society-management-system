		...
		<div id="templatemo_wrapper">
			...
			<center>
				<div>
					...
					<br>
					<p
						style="font-family: cursive; color: maroon; font-size: 20px; font-weight: bolder;">Owners
						entry</p>
					<table>
						<tr>
							<td>Enter Flat No:</td>
							<td><input type="text" name="flatno" placeholder="FlatNo:"
								required size="50px" /></td>
						</tr>

						<tr>
							<td></td>
							<td align="right"><input type="submit" name="sowner"
								value="proceed" style="width: 100px; height: 40px" /><br><font style="color: red;font-weight: bold;">${err}</font></td>
						</tr>
