...
<center><div>
<br><br><br><br>
<p style="font-family: cursive;color: maroon;font-size: 35px;font-weight: bolder;">Members of Flat</p><br>
<table>
<thead>
<tr>
<td>Enter Flat Number : &nbsp;&nbsp;&nbsp;</td>
<td><input type="text" name="fl" placeholder="Enter Flat Number" size="30px" required/></td>
</tr>
<tr align="right"><td colspan="2"><input type="submit" value="Proceed" style="width: 100px; height: 40px"/><br><font style="color: red;font-weight: bold;">${err}</font></td></tr>
</table>
<br><br><br><br><br><br>
</div></center>
	</div>
